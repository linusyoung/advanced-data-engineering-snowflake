...
# Set up basic logging
    ...
    try:
        ...
        telemetry.add_event("query_begin",{"decription": "Starting to query order_header_stream"})
        ...
        telemetry.add_event("query_begin",{"decription": "Completed query order_header_stream"})
